...
void ShaderProgram::drawInterleaved(Drawable &d, bool isTransparent) {
    useMe();

    BufferType buffer = isTransparent ? TRANSPARENT_INTERLEAVED : INTERLEAVED;
    BufferType index = isTransparent ? TRANSPARENT_INDEX : INDEX;
